...
<body>
    ...
    <div id="wrapper">
        ...
        <header id="page-header-wrapper">
           <p class="page-title" style="padding-left: 10px;">PET EXPERT ACCOUNT</p>
        </header>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mobile-wrap" style="padding:0px;">
                            <img src="images/profile_user-two.jpg" class="img-fluid" style="border-radius: 10px 10px 0px 0px;">
                            ...
                            <div class="mx-2">
                              ...
                              <div class="form-row px-3">
                                 <div class="form-group col-md-6">
                                    <a href="chat-room-user.html" class="btn btn-custom-one mt-4" style="width:100%;">CHAT NOW!</a>
                                </div>
                                <div class="form-group col-md-6">
                                     <a href="dashboard.html" class="btn btn-custom-one mt-4" style="width:100%;">VIEW MORE</a>
                                </div>
                            </div>
                        </div>
                    </div>
