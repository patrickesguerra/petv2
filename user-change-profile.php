                            ...
                            <div class="mx-2" >
                                 ...
                                 <form id="registerform" class="p-4">
                                        <div class="form-group">
                                             <center>
                                                   <img src="images/profile_user.jpg" class="img-fluid" style="height: 100px; width: 100px;border-radius: 100%;">
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <label for="exampleInputPassword1" class="">Occupation</label>
                                        <select id="inputState" class="form-control">
                                            <option selected>Choose...</option>
                                            <option>Occupation One</option>
                                            <option>Occupation Two</option>
                                          </select>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="exampleInputPassword1" class="">Affiliates</label>
                                        <textarea class="form-control" ></textarea>
                                      </div>
                                       <div class="form-row">
                                             <div class="form-group col-md-6">
                                                    <button type="submit" class="btn btn-custom-one mt-2" style="width: 160px;">CANCEL CHANGES</button>
                                            </div>
                                            <div class="form-group col-md-6">
                                                 <button type="submit" class="btn btn-custom-one mt-2" style="width: 160px;">SAVE CHANGES</button>
                                            </div>
